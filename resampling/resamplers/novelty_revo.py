...
class NoveltyREVOResampler(CloneMergeResampler):
            ...
            if num_walker_copies[i] > 0:
                for j in range(i+1, num_walkers):
                    ...
                    if num_walker_copies[j] > 0:
                        ...
                        partial_variation = ((distance_matrix[i][j] / self.char_dist) ** self.dist_exponent) * walker_novelties[i] * walker_novelties[j]
    ...
    def decide(self, walker_weights, num_walker_copies, distance_matrix, images):
        ...
        print("Starting variance optimization:", variation)
        ...
        while productive:
            ...
            if len(merge_pair) != 0:
                ...
                if new_variation > variation:
                    ...
                    print("Variance move to", new_variation, "accepted")
                    ...
                    print("variance after selection:", new_variation)
    ...
    def _all_to_all_distance(self, walkers):
        ...
        for i, j in it.combinations(range(len(images)), 2):
            ...
            dist_mat[i][j] = dist
            dist_mat[j][i] = dist
        #print(np.mean([walker_dists for walker_dists in dist_mat]),'**********************')
