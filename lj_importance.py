...
from resampling.resamplers.importance import ImportanceResampler
from resampling.resamplers.importance import JarzynskiImportance
...
# the outputs path
outputs_dir = osp.realpath(f'./outputs/importance/{epsilon}_eps/{Amp_fac}')
...
Imp = JarzynskiImportance(beta=Beta, amplification=Amp_Fac)
resampler = ImportanceResampler(imp=Imp, n_wt_based=5)
